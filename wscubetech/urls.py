...
urlpatterns = [
    ...
    path("foods/", views.FoodsPage, name="foods"),
    path("orders/", views.OrderPage, name="orders"),
    path("categories/", views.CategoriesPage, name="categories"),
    path("userform", views.UserFormPage, name="userForm"),
    path("submituserform", views.SubmitUserFormPage, name="submituserform"),
    
    path("newsdetails/<slug>/", views.NewsDetailsPage, name="newsDetails"),
